      ...
      <section className="py-12 bg-medical-blue text-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <Users className="h-8 w-8 mx-auto mb-2 text-medical-teal-light" />
              <div className="text-3xl font-bold mb-1">16,000+</div>
              <div className="text-sm text-gray-200">Successful Surgeries</div>
            </div>
            <div>
              <Globe className="h-8 w-8 mx-auto mb-2 text-medical-teal-light" />
              <div className="text-3xl font-bold mb-1">50+</div>
              <div className="text-sm text-gray-200">Countries Served</div>
            </div>
            <div>
              <Award className="h-8 w-8 mx-auto mb-2 text-medical-teal-light" />
              <div className="text-3xl font-bold mb-1">25+</div>
              <div className="text-sm text-gray-200">Years Experience</div>
            </div>
            <div>
              <Clock className="h-8 w-8 mx-auto mb-2 text-medical-teal-light" />
            ...
            <div className="bg-gradient-to-br from-medical-blue to-medical-blue-dark text-white rounded-xl overflow-hidden shadow-lg">
              <div className="p-8">
                <div className="flex items-center mb-6">
                  <Heart className="h-10 w-10 mr-4 text-medical-teal-light" />
                  <div>
                    <h3 className="text-2xl md:text-3xl font-bold">Congenital Heart Disease</h3>
                    <p className="text-gray-200">Pediatric & Adult CHD Program</p>
                  </div>
                </div>
                <div className="space-y-4 mb-6">
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-medical-teal-light rounded-full"></div>
                    <span>Comprehensive evaluation and treatment</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-medical-teal-light rounded-full"></div>
            ...
            <div className="bg-gradient-to-br from-medical-teal to-medical-teal-dark text-white rounded-xl overflow-hidden shadow-lg">
              <div className="p-8">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl md:text-3xl font-bold">International Patient Program</h3>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <span>Virtual pre-consultation</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-white rounded-full"></div>
                    <span>Visa and travel assistance</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-white rounded-full"></div>
                    <span>Airport pickup and accommodation</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-white rounded-full"></div>
