  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "World-class heart surgery in India for GCC patients. Dr. M.K. Moosa Kunhi offers expert cardiac care with over 16,000 successful surgeries. Affordable medical tourism from UAE, Saudi Arabia, Qatar, Oman, Kuwait, and Bahrain."
      );
    }
  }, []);
    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-24 bg-gradient-to-r from-medical-blue to-medical-teal text-white overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          ...
          >
            <path 
              d="M500,990C244.77,990,38.09,760.48,10,515.72,38.09,270.95,244.77,10,500,10c255.23,0,461.91,260.95,490,505.72C961.91,760.48,755.23,990,500,990Z" 
              fill="none" 
              stroke="currentColor" 
              strokeWidth="2"
            />
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a 
                href="#contact"
                className="bg-white text-medical-blue hover:bg-medical-gold hover:text-white transition-colors px-6 py-3 rounded-sm font-medium text-lg"
              >
                Contact International Coordinator
              </a>
              <Link 
                to="/services"
                className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-medical-blue transition-colors px-6 py-3 rounded-sm font-medium text-lg"
              >
      ...
      <section id="contact" className="py-16 md:py-24 bg-medical-teal text-white">
        <div className="container mx-auto px-4">
          ...
          <motion.div 
            ...
            viewport={{ once: true, margin: "-100px" }}
            variants={fadeInUp}
            className="max-w-3xl mx-auto bg-white text-gray-800 rounded-lg shadow-xl overflow-hidden"
          >
            <div className="p-8">
                    ...
                    <li className="flex items-center">
                      ...
                      <div>
                        <a 
                          ...
                          className="hover:text-medical-teal transition-colors block"
                        >
                          6505422@gmail.com
                        </a>
                        <a 
      ...
      <section className="py-16 md:py-20 bg-medical-gray">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <a 
              href="#contact"
              className="bg-medical-blue text-white hover:bg-medical-teal transition-colors px-8 py-4 rounded-sm font-medium text-lg inline-block"
            >
              Contact International Coordinator
            </a>
          </motion.div>
