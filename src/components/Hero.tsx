...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative bg-medical-gray pt-16 md:pt-24 flex items-center">
          ...
          <div className="flex justify-center md:justify-end animate-slide-up order-1 md:order-2 mb-6 md:mb-0">
            <div className="relative">
              <div className="w-56 h-56 md:w-72 md:h-72 lg:w-80 lg:h-80 rounded-sm overflow-hidden shadow-xl">
                <img 
                  src="/lovable-uploads/a3b2c087-8cb1-4ada-b500-e16c8565954c.png" 
          ...
          >
            ...
            {animationStage > 0 && (
              <path
                ...
                className={`animate-heartbeat ${isMobile ? 'reduce-animation' : ''}`}
              />
            )}
          </svg>
        </div>
